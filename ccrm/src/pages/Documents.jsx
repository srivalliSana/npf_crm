                  ...
                  <tr key={d.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="table-td">
                      <div className="flex items-center gap-1.5">
                        <button onClick={() => showToast('Displaying visual document secure preview...', 'info')} className="p-1 rounded hover:bg-blue-50 text-blue-500 focus:outline-none" title="View"><Eye size={14} /></button>
                        {d.status !== 'Verified' && (
          ...
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md overflow-hidden animate-scale-up">
            ...
            <form onSubmit={handleUploadSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <div
                  onClick={() => showToast('Simulated choosing file...', 'info')}
